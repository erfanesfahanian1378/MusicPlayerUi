            ...
            <View style={styles.modal}>
              ...
              <View style={styles.modalData}>
                <View style={styles.playerContainer}>
                  <Text style={{color : "white" , fontSize : responsiveFontSize(1.5)}}>{item.title}</Text>
                  <Text style={[styles.subTitle , {fontSize : responsiveFontSize(2)}]}>{item.subTitle}</Text>
                ...
                <View style={styles.option}>
                  <Icon name="heart" size={30} color="#ff5b77" />
                  <Text style={styles.text}>اضافه کردن به علاقه مندی</Text>
                </View>
                {/* <View style={styles.option}>
                 ...
                 <View style={styles.option}>
                  ...
                  <Text style={styles.text}>اضافه کردن به پلی‌لیست</Text>
                </View>
                {/* <View style={styles.option}>
                 ...
                 <View style={styles.option}>
                  <Icon name="album" size={30} color="#fff" />
                  <Text style={styles.text}>ایجاد آلبوم</Text>
                </View>
                {/* <View style={styles.option}>
                ...
                <View style={styles.option}>
                  ...
                  <Text style={styles.text}>بارگیری</Text>
                </View>
              </View>
            </View>
          </View>
